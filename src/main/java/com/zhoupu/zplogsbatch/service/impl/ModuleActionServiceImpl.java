...
import com.zhoupu.zplogsbatch.repository.ModuleActionRepository;
...
public class ModuleActionServiceImpl implements ModuleActionService {
	...
	@Override
	public void save(ModuleAction u) {
	    moduleActionRepository.save(u);
	}
	...
	public Map<String, Object> getInfoListMap(Map<String, Object> map) {
		...
		int page = start / size;
		Page<ModuleAction> pageContent = findAll(page, size);
	...
	@Override
	public Page<ModuleAction> findAll(int page, int size) {
		PageRequest pageable = new PageRequest(page, size);
		Page<ModuleAction> pages = moduleActionRepository.findAll(pageable);
		return pages;
	}

	@Override
	public ModuleAction findOne(Long id) {
		return moduleActionRepository.findOne(id);
	}
	...
	public void delete(String ids) {
		...
		listIds.forEach(id -> {
		    moduleActionRepository.delete(id);
		});
	}
